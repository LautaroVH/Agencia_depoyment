...
INSERT INTO `testimoniales` VALUES (0,'zxghfg','asd@asd.com',', value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre'),(0,'zxghfg','asd@asd.com',', value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre'),(0,'zxghfg','asd@asd.com',', value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre, value=nombre'),(0,'rq434','argre','4r4t434'),(0,'lululu','fgfufkuj','rt5ete5ye5yte5te5t5te5te5t'),(0,'5454','345345','567567'),(0,'Lauti','asff@as.com','siiiiii');
/*!40000 ALTER TABLE `testimoniales` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `testimoniales1`
--

DROP TABLE IF EXISTS `testimoniales1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `testimoniales1` (
...
--
-- Dumping data for table `testimoniales1`
--

LOCK TABLES `testimoniales1` WRITE;
/*!40000 ALTER TABLE `testimoniales1` DISABLE KEYS */;
/*!40000 ALTER TABLE `testimoniales1` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-21 11:08:24
